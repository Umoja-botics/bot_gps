...
#import some_gps_conversion_library  # Bibliothèque hypothétique pour la conversion GPS
import utm
...
class GPSToMapNode(Node):
    ...
    def gps_callback(self, msg):
        ...
        #x, y = some_gps_conversion_library.convert_gps_to_utm(msg.latitude, msg.longitude)
